...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        guard let mainViewController = window?.rootViewController as? MainScreenViewController,
            let splitViewContoller = mainViewController.viewControllers?.last as? FavouriteViewController,
        ...
        let firstMonster = masterViewController.dbModel?.first
        detailViewController.dbModel = firstMonster
